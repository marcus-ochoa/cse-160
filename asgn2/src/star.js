class Star {
    ...
    render() {
        ...
        for (let angle = 0; angle < 360; angle += angleStep) {
            ...
            let nextHalfAngle = angle + angleStep / 2;
            let vec1 = [
            ...
            let vec3 = [
                Math.cos((nextHalfAngle * Math.PI) / 180) * 2 * d,
                Math.sin((nextHalfAngle * Math.PI) / 180) * 2 * d,
            ];
            let point1 = [
            ...
            let point3 = [
                this.position[0] + vec3[0],
                this.position[1] + vec3[1],
            ];
